...
class BarcodeGeneratorPNG extends BarcodeGenerator {
     ...
     * @public
     */
    public function getBarcode($code, $type, $widthFactor = 2, $totalHeight = 20, $color = array(0, 0, 0)) {
        ...
        foreach ($barcodeData['bars'] as $bar) {
            ...
            if ($bar['drawBar']) {
                ...
                if ($imagick) {
                    ...
                    imagefilledrectangle($png, $positionHorizontal, $y, ($positionHorizontal + $bw) - 1, ($y + $bh), $colorForeground);
                }
            }
